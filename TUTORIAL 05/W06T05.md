...
FIXED ANSWER: 
![T05Q01A CORRECTED](T05Q01ACorrected.png)
...
```
FIXED ANSWER:
- To set new value based on the given index and
- To return the old value that has been replaced with
```
...
13                return null;
14            }else{
15                for (int i = 0; i < index; i++) {//change > to <
16                    current=current.next;
17                }
18                element =current.element;
19                current.element = e;
20                return element;
21           }
    }
```
...
![T05Q02A Corrected](T05Q02ACorrected.png)
...
![T05Q02B Corrected](T05Q02BCorrected.png)
...
![T05Q03 Corrected](T05Q03Corrected.png)
